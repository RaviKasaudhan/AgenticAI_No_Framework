...
class WriteArticleValidatorAgent(AgentBase):
    ...
    def execute(self, topic, article, outline=None):
        ...
        user_content = (
            "Given the topic and the article, assess whether the article comprehensively "
            "covers the topic, follows a logical structure, and maintains academic standards.\n"
